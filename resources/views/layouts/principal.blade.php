    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="index.html">Hotel 1 v1.0</a>
            </div>
            <!-- /.navbar-header -->
            ...
            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            <a href="registro.php"><i class="fa fa-table fa-fw"></i> Registro</a>
                        </li>
                        <li>
                        ...
                        <li>
                            ...
                            <ul class="nav nav-second-level">
                                <li>
                                    <a href="/show_usuarios">Usuarios</a>
                                </li>
                                <li>
                                    <a href="/show_habitaciones">Habitacion</a>
                                </li>
                                <li>
                                    <a href="/show_empresas">Empresas</a>
                                </li>
                            </ul>
                            <!-- /.nav-second-level -->
                        </li>
